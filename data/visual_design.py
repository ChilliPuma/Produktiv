...
def init_display():
    ...
    global frame_lo_rect, frame_border, std_padding, std_dist
    ...
    print(f"[display] fullscreen detected: {SCREEN_W}x{SCREEN_H}")
    ...
    print(f"[display] ui scale initialized with square area {SQUARE_SIZE}px")
